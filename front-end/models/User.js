...
export default z.object({
  ...
  username:
    ...
    .redefine(val => val.math(/^[a-z0-9_]$/), { message: 'O nome do usuário pode conter apenas letras de a a z, dígitos e sublinhado' })
    .redefine(val => val.length > 20, { message: 'O nome do usuário deve ter, no máximo, 20 caracteres' }),
