...
export default z.object({
  ...
  fullname:
    ...
    .includes(' ', { message: 'O nome deve ter um espaço em branco separando o nome e sobrenome' }),
...
//     // Obs.: é possível fazer validaões mais complexas usando regex,
//     // mas não abordaremos aqui
  ...
  delay_level:
    z.number().nonnegative()
    .lte(6, { message: 'O número de retardo deve ser menor ou igual a 6' }),
...
.refine(user => {
    ...
    // A mensagem de erro estará associada ao compo "password2"
    path: ['password2'] 
})
.refine(user => {
