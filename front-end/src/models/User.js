...
export default z
  .object({
    fullname: z
      ...
      .includes(" ", {
        message:
          "O nome deve ter um espaço em branco separando nome e sobrenome",
      }),
    ...
    username: z
      ...
      .refine((val) => val.match(/^[a-z0-9_]{1,20}$/), {
        message:
          "O nome do usuário pode conter apenas letras de a a z, dígitos e sublinhado",
      })
    ...
    login_attempts: z.number().nonnegative().lte(3, {
      message: "O número de tentativas deve ser menor ou igual a 3",
    }),
